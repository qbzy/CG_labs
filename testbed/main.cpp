...
veekay::mat4 Camera::view_projection(float aspect_ratio) const {
        ...
        // NOTE: Matrices are stored column-major, but the helper builds projection
        //       with a layout that expects multiplication order matching the
        //       original skeleton (view * projection). Keep that behavior so
        //       objects remain visible with the current shader convention.
